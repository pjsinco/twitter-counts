...
if (!$results) {
  echo 'All the old engagement search results have been collected.';
  exit;
}

// prep the api request
$engagement_user_id = $results[0]['user_id'];
$engagement_screen_name = $results[0]['screen_name'];
$max_id = 0;
...
// timestamp old_search_collected for this user
DB::instance()->update_row(
...
echo 'Collected search for ' . $engagement_screen_name . PHP_EOL;
