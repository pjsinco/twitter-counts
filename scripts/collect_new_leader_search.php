...
// get all leadr accts that have had their old search results collected
$q = "
...
foreach ($results as $user) {
  ...
  file_tweets($leader_user_id, $screen_name, $search_since_id);

}

function file_tweets($leader_user_id, $leader_screen_name, $since_id) {
